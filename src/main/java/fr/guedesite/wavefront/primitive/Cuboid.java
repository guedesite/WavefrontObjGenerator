 ...
 */
package fr.guedesite.wavefront.primitive;

import java.math.BigDecimal;
import java.util.Arrays;
import java.util.List;

import fr.guedesite.wavefront.Coordinate;
import fr.guedesite.wavefront.Face;
import fr.guedesite.wavefront.Obj;
import fr.guedesite.wavefront.V;
import fr.guedesite.wavefront.Vec;
import fr.guedesite.wavefront.op.Translation;
